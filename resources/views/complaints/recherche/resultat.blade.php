...
@section('content')
    <div class="grid md:grid-cols-4 gap-4">
        ...
        <div class="shadow-xl border p-4 md:col-span-1">
            ...
            <form action="{{ route('complaint.search') }}" method="POST">
                @csrf

                <div class="mt-3">
                    <label for="">Nom(s) complet :*</label>
                    <select name="teacher" class="@error('teacher') is-invalid @enderror w-64">
        ...
        <div class="shadow-xl border p-4 md:col-span-1">
            <h1 class="font-semibold text-xl">Recherche par Campus</h1>

            <form action="{{ route('complaint.search-school') }}" method="POST">
                @csrf

                <div class="mt-3">
                    <label for="">Nom de l'établissement :*</label>
                    <select name="school" class="@error('teacher') is-invalid @enderror">
    ...
    <div class="p-4 border-black border rounded mt-5">
